...
local _addonName, ADDONSELF = ...;
ADDONSELF.Creator = "ZkySettingsCreator"
...
function ADDONSELF:GetSettingsBuilder()
    return settings;
end

function ADDONSELF:gogogo()
    print('this is ZkySettingsCreator');
end
